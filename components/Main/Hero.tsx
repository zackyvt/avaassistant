...
function HeroRight() {
    return (
        <div className="md:w-full lg:-mt-20 md:ml-16 lg:ml-32 w-3/4 sm:w-2/4 self-center sm:self-start max-w-2xl">
            <div className="p-1.5 rounded-md w-full h-fit bg-gradient-to-r from-pink to-purple flex flex-col justify-between">
                <img alt="avaassistant screenshot" src="https://addons.mozilla.org/user-media/previews/full/249/249437.png?modified=1622136457"/>
            </div>
        </div>
    )
}
