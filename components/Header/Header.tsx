...
export default function Header(props: HeaderProps) {
    return (
        <header className="flex w-full text-white pt-8 font-sans">
            ...
            <button className="hidden transition-all sm:block font-medium h-fit p-2 pl-5 pr-5 bg-white text-black rounded-lg text-sm hover:scale-105" onClick={() => window.location.href = "/dashboard"}>Sign In</button>
        </header>
    )
}