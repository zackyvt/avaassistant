    ...
    return (
        <Page page="Terms of Service">
            <main className="mt-16">
                <h1 className="font-bold text-3xl text-center sm:text-left">Terms of Service</h1>
                <p className="text-1xl text-center sm:text-left">Last Updated: Pending</p>
                <p className="mt-10 text-sm text-center sm:text-left">
                    <b className="text-lg">1. AGREEMENT TO TERMS</b>
                    <br></br>
                    These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and AvaAssistant (“we,” “us,” or “our”), concerning your access to and use of the https://avaassistant.xyz/ website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                    <br></br>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">2. INTELLECTUAL PROPERTY RIGHTS</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">3. USER REPRESENTATIONS</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">4. CONTRIBUTION LICENSE</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">5. SUBMISSIONS</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">6. THIRD-PARTY WEBSITE AND CONTENT</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">7. ADVERTISERS</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">7. PRIVACY POLICY</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">8. TERM AND TERMINATION</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">9. GOVERNING LAW</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">10. CORRECTIONS</b>
                    <br></br>
                    There may be information on the Site that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.
                    <br></br>
                    <br></br>
                    <b className="text-lg">11. DISCLAIMER</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">12. LIMITATIONS OF LIABILITY</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">13. INDEMNIFICATION</b>
                    <br></br>
