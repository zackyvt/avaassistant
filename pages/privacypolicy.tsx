        ...
        <Page page="Privacy Policy">
            <main className="mt-16">
                ...
                <p className="mt-10 text-sm text-center sm:text-left">
                    ...
                    <br></br>
                    <b>“Services,”</b> we are referring to our Website, Bot, and other related services, including sales, marketing, or events.
                    <br></br>
                    <br></br>
                    The purpose of this privacy notice is to explain to you in the clearest way possible what information we collect, how we use it, and what rights you have in relation to it. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.
                    <br></br>
                    <br></br>
                    <b className="text-lg">1. PERSONAL INFORMATION DISCLOSED TO US</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    Personal Information Provided by You. We collect email addresses; contact preferences; contact or authentication data; and other similar information.
                    <br></br>
                    <br></br>
                    All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.
                    <br></br>
                    <br></br>
                    <b className="text-lg">2. INFORMATION AUTOMATICALLY COLLECTED</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">4. HOW LONG DO WE KEEP YOUR INFORMATION?</b>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <b className="text-lg">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</b>
                    <br></br>
